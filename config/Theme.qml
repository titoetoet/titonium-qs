...
QtObject {
    ...
    readonly property color borderSubtle: Qt.alpha(contentColour, 0.04)
    readonly property color borderDefault: Qt.alpha(contentColour, 0.10)
    readonly property color borderAccent: Qt.alpha(accentColour, 0.45)
    readonly property color popupBorder: themeName === "light" ? Qt.alpha("#000000", 0.08) : Qt.alpha("#ffffff", 0.14)
    readonly property color surfaceHover: Qt.alpha(contentColour, 0.08)
    readonly property color surfaceHoverStrong: Qt.alpha(contentColour, 0.14)
